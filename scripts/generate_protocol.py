...
def build():
    ...
    points = (
        "преамбулы, п. п. 1.1, 1.2, 1.3, 1.9, 2.2, 2.3, 3.1.6, 3.1.7, 3.1.9, 3.1.10, 3.1.11, "
        "3.1.17, 3.2, 3.3.1, 3.3.4, 3.3.6, 3.3.10 (излагается как п. 3.3.9), 3.3.21, 3.4.3, "
        "3.4.4, 4.1, 5.1, 5.2, 6.3, 6.5, 7.4 договора и приложения № 1"
    )
